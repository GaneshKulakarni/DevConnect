        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="hidden md:block">
              <div className="bg-gradient-to-br from-cyan-500/10 to-blue-500/10 border border-cyan-900/30 rounded-xl p-8 font-mono text-sm text-gray-300 shadow-2xl backdrop-blur-sm">
                <div className="text-green-400 mb-3">// Connect with developers</div>
                ...
                <div className="text-cyan-400 mt-3">share<span className="text-emerald-400">.</span>build<span className="text-emerald-400">.</span>grow()</div>
              </div>
            </div>
          </div>
        </div>
